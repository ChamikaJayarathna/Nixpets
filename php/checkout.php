        ...
        <section class="checkout-form">
            ...
            <form action="" method="POST">
                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                        <span>city</span>
                        <input type="text" placeholder="e.g. new york" name="city" required>
                    </div>
                    <div class="inputBox">
                        <span>state</span>
                        <input type="text" placeholder="e.g. Texas" name="state" required>
                    </div>
                    <div class="inputBox">
                        <span>country</span>
                        <input type="text" placeholder="e.g. USA" name="country" required>
                    </div>
                    <div class="inputBox">
                        <span>pin code</span>
